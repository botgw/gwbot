const  XBOT = 'YB-BOTv3.0'; // Nama Bot Whatsapp
const instagram = 'https://instagram.com/connection77_'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+628116688100'; // Nomor whatsapplu cok
const aktif = 'Tergantung Mood Bujanx'; // Kapan bot lu aktif
...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=628116688100:+62 811-888-100\n' // WhatsApp ID + phone number
            + 'END:VCARD'
...
conn.sendMessage(id, 'Owner YB-BOT wa.me/+628116688100' ,MessageType.text);
}
else if (text == 'Agung'){
conn.sendMessage(id, 'Aku BOT nya YB-BOY' ,MessageType.text);
}
else if (text == 'wenda'){
...
conn.sendMessage(id, {displayname: "-YB", vcard: vcard}, MessageType.contact)
...
conn.sendMessage(id, ' Thanks Telah Menggunakan BOT *YB-BOT* , Follow Instagram Mimin Yah� : https://instagram.com/@betrayed.x_' ,MessageType.text);
}
else if (text == '#info'){
conn.sendMessage(id, ' Thanks Telah Menggunakan BOT *YB-BOT* , Follow Instagram Mimin Yah� : https://instagram.com/@betrayed.x_' ,MessageType.text);
}
